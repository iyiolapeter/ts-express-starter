...
type CustomValidator = (value: any, obj?: any) => Promise<boolean> | boolean;
type CustomSanitizer = (value: any, obj?: any) => Promise<any> | any;
type Predicate = keyof Validator | CustomValidator;
...
export interface ValidationNode extends Validator {
  customValidator(validator: CustomValidator): this;
  customSanitizer(snaitizer: CustomSanitizer): this;
  end(): ValidationRule;
}

export function node(id: string): ValidationNode;
export function validate(obj: object, nodes: ValidationNode[], options?: any): Promise<[]>;
